...
Common issues (MicroXRCE agent, package-not-found, build hangs, camera/depth, PX4/Ethernet/HITL) are documented in [docs/TROUBLESHOOTING.md](docs/TROUBLESHOOTING.md).
